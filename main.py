...
st.set_page_config(
    ...
    menu_items={
        ...
        A powerful tool for generating and translating video subtitles using AI.
...
def main():
    ...
    st.markdown("""
        ### 🚀 Key Features
        - **Automatic Transcription**: Generate accurate subtitles using OpenAI's Whisper
        - **Multiple Languages**: Translate to 20+ languages including Arabic, Hindi, and more
        - **Format Support**: Export in SRT, VTT, ASS, and SUB formats
        - **Batch Processing**: Handle multiple videos simultaneously
        - **Timing Tools**: Fine-tune subtitle timing with precision
        
        ### 💡 How It Works
        1. Upload your video file(s)
        2. Choose your target language
        3. Select subtitle format
        4. Get instant transcription and translation
        5. Preview and adjust timing
        6. Download your subtitles
        ...
        - Anyone needing quick, accurate video subtitles
    """)
